...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ADFYouTube", targets: ["ADFYouTube"]),
    ...
    targets: [
        ...
        .target(name: "ADFYouTube", dependencies: ["ADFModel", "ADFPreparation", "ADFRendering"]),
        .testTarget(name: "ADFYouTubeTests", dependencies: ["ADFYouTube", "ADFModel", "ADFPreparation"]),
